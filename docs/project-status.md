...
- [x] Add the current-day selector used to validate per-day counts.
- [x] Replace starter markup with semantic, accessible timer UI that exposes duration choices, countdown, progress text, controls, completion state, daily total, and the testing day selector.
- [x] Add focused component tests for the core user flows: default ready state, preset selection, start/pause/resume/reset, completion increments exactly once, refresh persistence, and selected-day totals.
